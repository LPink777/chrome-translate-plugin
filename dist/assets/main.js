        ...
        : l != null &&
          (Vu(l) &&
            (l = mc(
              l,
              n +
                (!l.key || (o && o.key === l.key) ? '' : ('' + l.key).replace(jo, '$&/') + '/') +
                e
            )),
          t.push(l)),
      1
...
var oe = { current: null },
  wr = { transition: null },
  yc = { ReactCurrentDispatcher: oe, ReactCurrentBatchConfig: wr, ReactCurrentOwner: Au };
function qi() {
...
function bi(e, t, n) {
  ...
  return { $$typeof: kc, type: e, key: u, ref: o, props: l, _owner: xc.current };
}
el.Fragment = Sc;
el.jsx = bi;
el.jsxs = bi;
 ...
 */ (function (e) {
      ...
      e: for (var H = 0, X = x.length, bn = X >>> 1; H < bn; ) {
        ...
        if (0 > l(gl, z))
          vt < X && 0 > l(er, gl)
            ? ((x[H] = er), (x[vt] = z), (H = vt))
            : ((x[H] = gl), (x[ht] = z), (H = ht));
        else if (vt < X && 0 > l(er, z)) (x[H] = er), (x[vt] = z), (H = vt);
        else break e;
      }
    }
    return P;
  ...
  function E(x, P) {
    ...
    var z = p;
    try {
      for (d(P), h = n(s); h !== null && (!(h.expirationTime > P) || (x && !_e())); ) {
        var H = h.callback;
    ...
    (e.unstable_scheduleCallback = function (x, P, z) {
      ...
      return (
        ...
        z > H
          ? ((x.sortIndex = z),
            t(c, x),
            n(s) === null && x === n(c) && (k ? (f(N), (N = -1)) : (k = !0), yl(v, z - H)))
...
function Uc(e, t, n, r, l, u, o, i, s) {
  (xn = !1), (Rr = null), jc.apply(Fc, arguments);
}
...
var xs = ve.unstable_scheduleCallback,
...
function Zc(e, t) {
  for (
    ...
    var o = 31 - Re(u),
      i = 1 << o,
      s = l[o];
    s === -1 ? (!(i & n) || i & r) && (l[o] = Gc(i, t)) : s <= t && (e.expiredLanes |= i),
      (u &= ~i);
  }
}
function su(e) {
...
function pn(e, t) {
  e.blockedOn === t &&
    ((e.blockedOn = null),
    au || ((au = !0), ve.unstable_scheduleCallback(ve.unstable_NormalPriority, ef)));
}
function jn(e) {
  function t(l) {
    return pn(l, e);
...
function qu(e, t, n, r) {
  if (Ir) {
    ...
    if (l === null) Dl(e, t, r, jr, n), Yo(e, r);
      ...
      for (; l !== null; ) {
        var u = Jn(l);
        if ((u !== null && zs(u), (u = cu(e, t, n, r)), u === null && Dl(e, t, r, jr, n), u === l))
          break;
        l = u;
      }
...
var jr = null;
function cu(e, t, n, r) {
  if (((jr = null), (e = Xu(r)), (e = kt(e)), e !== null))
...
var un = {
  ...
  uf = ge(lf),
  of = A({}, Zn, { relatedTarget: 0 }),
  Pl = ge(of),
  sf = A({}, un, { animationName: 0, elapsedTime: 0, pseudoElement: 0 }),
  af = ge(sf),
  cf = A({}, un, {
...
var yf = A({}, Zn, {
  ...
  Sf = ge(kf),
  Ef = A({}, un, { propertyName: 0, elapsedTime: 0, pseudoElement: 0 }),
  xf = ge(Ef),
  Cf = A({}, nl, {
    deltaX: function (e) {
...
var Pf = We && 'TextEvent' in window && !Cn,
  Is = We && (!no || (Cn && 8 < Cn && 11 >= Cn)),
  bo = ' ',
  ei = !1;
function js(e, t) {
  switch (e) {
...
function Tf(e, t) {
  if (It)
    return e === 'compositionend' || (!no && js(e, t))
      ? ((e = Ds()), (Sr = bu = et = null), (It = !1), e)
      : null;
  switch (e) {
    case 'paste':
      return null;
      ...
      if (p !== void 0) {
        ...
        for (var a = c, d; a !== null; ) {
          ...
          if (
            (d.tag === 5 &&
              v !== null &&
              ((d = v), f !== null && ((v = Mn(a, f)), v != null && k.push(An(a, v, d)))),
            j)
          )
            break;
          a = a.return;
    ...
    if (!(t & 7)) {
      e: {
        if (
          ...
          p && n !== lu && (w = n.relatedTarget || n.fromElement) && (kt(w) || w[Qe]))
        )
          break e;
        if (
          (g || p) &&
          ...
          g
            ? ((w = n.relatedTarget || n.toElement),
              (g = c),
              (w = w ? kt(w) : null),
              w !== null && ((j = Rt(w)), w !== j || (w.tag !== 5 && w.tag !== 6)) && (w = null))
            : ((g = null), (w = c)),
          g !== w)
        ) {
          if (
          ...
          g !== null && ai(h, p, g, k, !1), w !== null && j !== null && ai(h, j, w, k, !0);
        }
      }
      e: {
        if (
      ...
      switch (((C = c ? Ut(c) : window), e)) {
        case 'focusin':
          (ti(C) || C.contentEditable === 'true') && ((jt = C), (fu = c), (Nn = null));
          break;
        case 'focusout':
          Nn = fu = jt = null;
          break;
      ...
      N &&
        (Is &&
          ...
          (It || N !== 'onCompositionStart'
            ...
            : ((et = m), (bu = 'value' in et ? et.value : et.textContent), (It = !0))),
        (C = Fr(c, N)),
        0 < C.length &&
...
function mt() {
  if (!jl && Ae !== null) {
    ...
    try {
      ...
      throw (Ae !== null && (Ae = Ae.slice(e + 1)), xs(Gu, mt), l);
    } finally {
      (O = t), (jl = !1);
    }
  }
...
function bs(e, t, n) {
  (we[ke++] = Ve), (we[ke++] = Be), (we[ke++] = Nt), (Nt = e);
  var r = Ve;
  e = Be;
  var l = 32 - Re(r) - 1;
  (r &= ~(1 << l)), (n += 1);
  ...
  switch (e.tag) {
    case 5:
      ...
      return (
        ...
        t !== null ? ((e.stateNode = t), (he = e), (me = ut(t.firstChild)), !0) : !1
      );
    case 6:
      return (
        (t = e.pendingProps === '' || t.nodeType !== 3 ? null : t),
        t !== null ? ((e.stateNode = t), (he = e), (me = null), !0) : !1
      );
    case 13:
      return (
  ...
  if (F) {
    ...
    if (t) {
      ...
      if (!hi(e, t)) {
        ...
        t = ut(n.nextSibling);
        var r = he;
        t && hi(e, t) ? ea(r, n) : ((e.flags = (e.flags & -4097) | 2), (F = !1), (he = e));
      }
    } else {
      if (wu(e)) throw Error(y(418));
...
function dr(e) {
  ...
  } else me = he ? ut(e.stateNode.nextSibling) : null;
  return !0;
}
function ta() {
...
function na(e) {
  ...
  function w(f, a, d, v) {
    ...
    if (N === d.length) return n(f, _), F && yt(f, N), E;
    if (_ === null) {
      for (; N < d.length; N++)
        (_ = h(f, d[N], v)),
          _ !== null && ((a = u(_, a, N)), C === null ? (E = _) : (C.sibling = _), (C = _));
      return F && yt(f, N), E;
    }
  ...
  function k(f, a, d, v) {
    ...
    if (L.done) return n(f, _), F && yt(f, N), E;
    if (_ === null) {
      for (; !L.done; N++, L = d.next())
        (L = h(f, L.value, v)),
          L !== null && ((a = u(L, a, N)), C === null ? (E = L) : (C.sibling = L), (C = L));
      return F && yt(f, N), E;
    }
            ...
            for (var E = d.key, C = a; C !== null; ) {
              if (C.key === E) {
                if (((E = d.type), E === Dt)) {
                  ...
                  C.elementType === E ||
                  (typeof E == 'object' && E !== null && E.$$typeof === Ze && yi(E) === C.type)
                ) {
                  n(f, C.sibling),
                    (a = l(C, d.props)),
                    (a.ref = hn(f, C, d)),
...
function yo(e, t, n, r, l, u) {
  if (
    ...
    do {
      ...
      (u += 1), (G = K = null), (t.updateQueue = null), (Cr.current = ld), (e = n(r, l));
    } while (Pn);
  }
  if (
    ((Cr.current = Xr),
...
function $l(e) {
  ...
  if (l !== null) {
    ...
    do {
      ...
      if ((Pt & m) === m)
        ...
        s === null ? ((i = s = h), (o = r)) : (s = s.next = h), ($.lanes |= m), (zt |= m);
      }
      c = c.next;
    } while (c !== null && c !== u);
    s === null ? (o = r) : (s.next = i),
  ...
  if (((e = n.interleaved), e !== null)) {
    l = e;
    do (u = l.lane), ($.lanes |= u), (zt |= u), (l = l.next);
    while (l !== e);
...
function sa(e, t) {
  ...
  if (
    ...
    if (((n.flags |= 2048), Kn(9, ca.bind(null, n, r, l, t), void 0, null), Z === null))
      throw Error(y(349));
    Pt & 30 || aa(n, t, l);
  }
  return l;
...
function Sa(e, t, n) {
  return Pt & 21
    ? (Me(n, t) || ((n = Ns()), ($.lanes |= n), (zt |= n), (e.baseState = !0)), t)
...
function ed(e, t, n) {
  var r = st(e);
  if (((n = { lane: r, action: n, hasEagerState: !1, eagerState: null, next: null }), xa(e)))
    Ca(t, n);
...
function td(e, t, n) {
  ...
  if (xa(e)) Ca(t, l);
    ...
    (n = la(e, t, l, r)), n !== null && ((l = ue()), Oe(n, e, r, l), _a(n, t, r));
  }
}
function xa(e) {
  var t = e.alternate;
...
function Na(e, t, n) {
  ...
  return (
    typeof u == 'object' && u !== null
      ? (u = xe(u))
      : ((l = fe(t) ? _t : re.current),
        (r = t.contextTypes),
        (u = (r = r != null) ? qt(e, l) : ft)),
    (t = new t(n, u)),
...
function xu(e, t, n, r) {
  ...
  typeof u == 'object' && u !== null
    ? (l.context = xe(u))
    : ((u = fe(t) ? _t : re.current), (l.context = qt(e, u))),
...
function za(e, t, n) {
  ...
  return (
    u !== null &&
      ...
      (n.callback = function () {
        Cu(e, t), typeof r != 'function' && (it === null ? (it = new Set([this])) : it.add(this));
        var o = t.stack;
  ...
  return e.mode & 1
    ...
    : (e === t
        ...
        : ((e.flags |= 128),
          ...
          (n.flags &= -52805),
          n.tag === 1 &&
            (n.alternate === null ? (n.tag = 17) : ((t = He(-1, 1)), (t.tag = 2), ot(n, t, 1))),
          (n.lanes |= 1)),
      e);
}
...
function Pi(e, t, n, r, l) {
  ...
  return (
    ...
    e !== null && !ae
      ...
      : (F && n && lo(t), (t.flags |= 1), le(e, t, r, l), t.child)
  );
}
...
function La(e, t, n) {
  ...
  if (r.mode === 'hidden')
    ...
    u !== null ? ((r = u.baseLanes | n), (t.memoizedState = null)) : (r = n), M(Wt, pe), (pe |= r);
...
function _u(e, t, n, r, l) {
  ...
  return (
    ...
    e !== null && !ae
      ? ((t.updateQueue = e.updateQueue), (t.flags &= -2053), (e.lanes &= ~l), Ye(e, t, l))
      : (F && r && lo(t), (t.flags |= 1), le(e, t, n, l), t.child)
  );
}
function Ti(e, t, n, r, l) {
  ...
  if ((Gt(t, l), t.stateNode === null)) Nr(e, t), Na(t, n, r), xu(t, n, r, l), (r = !0);
  else if (e === null) {
    var o = t.stateNode,
      i = t.memoizedProps;
    o.props = i;
  ...
  if (((i = (o & e.childLanes) !== 0), ae || i)) {
    if (((r = Z), r !== null)) {
      ...
      (l = l & (r.suspendedLanes | o) ? 0 : l),
        l !== 0 && l !== u.retryLane && ((u.retryLane = l), Ke(e, l), Oe(r, e, l, -1));
    }
      ...
      if (((r = t.memoizedState), r !== null))
        return r.dehydrated !== null
          ...
          : n & t.child.childLanes
            ? Ma(e, t, n)
            : (M(U, U.current & 1), (e = Ye(e, t, n)), e !== null ? e.sibling : null);
      M(U, U.current & 1);
      break;
    case 19:
      ...
      if (!r.hasOwnProperty(c) && l.hasOwnProperty(c) && l[c] != null)
        if (c === 'style') {
          ...
          c !== 'dangerouslySetInnerHTML' &&
            ...
            c !== 'autoFocus' &&
            (Rn.hasOwnProperty(c) ? u || (u = []) : (u = u || []).push(c, null));
    for (c in r) {
      var s = r[c];
      if (
        ((i = l != null ? l[c] : void 0),
    ...
    case 5:
      ...
      if (((n = t.type), e !== null && t.stateNode != null))
        ...
        if (((e = Et(Ue.current)), dr(t))) {
          ...
          switch (((r[je] = t), (r[Vn] = u), (e = (t.mode & 1) !== 0), n)) {
            case 'dialog':
          ...
          for (var o in u)
            if (u.hasOwnProperty(o)) {
              ...
              o === 'children'
                ? typeof i == 'string'
                  ? r.textContent !== i &&
                    (u.suppressHydrationWarning !== !0 && fr(r.textContent, i, e),
                    (l = ['children', i]))
                  : typeof i == 'number' &&
                    r.textContent !== '' + i &&
                    (u.suppressHydrationWarning !== !0 && fr(r.textContent, i, e),
      ...
      return t.flags & 128
        ...
        : ((r = r !== null),
          r !== (e !== null && e.memoizedState !== null) &&
            r &&
            ((t.child.flags |= 8192),
            t.mode & 1 && (e === null || U.current & 1 ? Y === 0 && (Y = 3) : Po())),
          t.updateQueue !== null && (t.flags |= 4),
          te(t),
          null);
    case 4:
      return tn(), Tu(e, t), e === null && $n(t.stateNode.containerInfo), te(t), null;
    case 10:
...
function cd(e, t) {
  switch ((uo(t), t.tag)) {
    case 1:
      return (
        fe(t.type) && $r(), (e = t.flags), e & 65536 ? ((t.flags = (e & -65537) | 128), t) : null
      );
    case 3:
      return (
        tn(),
...
function dd(e, t) {
  ...
  for (mu = { focusedElem: e, selectionRange: n }, Ir = !1, S = t; S !== null; )
              ...
              case 1:
                if (w !== null) {
                  var k = w.memoizedProps,
                    j = w.memoizedState,
                    f = t.stateNode,
                    a = f.getSnapshotBeforeUpdate(t.elementType === t.type ? k : ze(t.type, k), j);
...
function Ua(e) {
  ...
  t !== null && ((e.alternate = null), Ua(t)),
    ...
    e.tag === 5 &&
      ((t = e.stateNode),
      t !== null && (delete t[je], delete t[Vn], delete t[yu], delete t[Xf], delete t[Gf])),
    (e.stateNode = null),
    (e.return = null),
    (e.dependencies = null),
...
function Aa(e, t, n) {
  ...
  switch (n.tag) {
    ...
    case 15:
      ...
      break;
    case 1:
      if (!ne && (Ht(n, t), (r = n.stateNode), typeof r.componentWillUnmount == 'function'))
        try {
  ...
  switch (e.tag) {
    ...
    case 22:
      if (
        ...
        e.mode & 1 ? ((ne = (c = ne) || m), Ne(t, e), (ne = c)) : Ne(t, e),
        De(e),
        r & 8192)
      ) {
...
function Oe(e, t, n, r) {
  ...
  Gn(e, n, r),
    (!(R & 2) || e !== Z) &&
      (e === Z && (!(R & 2) && (cl |= n), Y === 4 && be(e, q)),
      de(e, r),
      n === 1 && R === 0 && !(t.mode & 1) && ((rn = W() + 500), ol && mt()));
}
function de(e, t) {
...
function Ha(e, t) {
  ...
  if (t !== 0) {
    if ((t === 2 && ((l = su(e)), l !== 0 && ((r = l), (t = ju(e, l)))), t === 1))
      throw ((n = Yn), xt(e, 0), be(e, r), de(e, W()), n);
    if (t === 6) be(e, r);
    else {
      if (
      ...
      switch (((e.finishedWork = l), (e.finishedLanes = r), t)) {
        ...
        case 3:
          if ((be(e, r), (r & 130023424) === r && ((t = Co + 500 - W()), 10 < t))) {
            ...
            e.timeoutHandle = vu(gt.bind(null, e, se, $e), t);
            break;
          }
          gt(e, se, $e);
          break;
        case 4:
          ...
          if (
            ...
            e.timeoutHandle = vu(gt.bind(null, e, se, $e), r);
            break;
          }
          gt(e, se, $e);
          break;
...
function be(e, t) {
  for (
    t &= ~xo, t &= ~cl, e.suspendedLanes |= t, e.pingedLanes &= ~t, e = e.expirationTimes;
    0 < t;
...
function Ui(e) {
  ...
  if (n === 1) throw ((n = Yn), xt(e, 0), be(e, t), de(e, W()), n);
  if (n === 6) throw Error(y(345));
  return (
    (e.finishedWork = e.current.alternate), (e.finishedLanes = t), gt(e, se, $e), de(e, W()), null
  );
}
function _o(e, t) {
  var n = R;
    ...
    try {
      ...
      e: {
        ...
        if (
          ...
          var j = _i(o);
          if (j !== null) {
            !(j.flags & 65536) && (j.flags |= 256), Ni(j, o, i, u, t), oo(nn(s, i));
            break e;
          }
        }
...
function Po() {
  (Y === 0 || Y === 3 || Y === 2) && (Y = 4),
    Z === null || (!(zt & 268435455) && !(cl & 268435455)) || be(Z, q);
}
function qr(e, t) {
  var n = R;
  R |= 2;
...
function Ka(e) {
  ...
  (e.memoizedProps = e.pendingProps), t === null ? Ya(e) : (Q = t), (Eo.current = null);
}
function Ya(e) {
  var t = e;
  do {
...
function wd(e, t, n) {
  ...
  r !== null && r.delete(t),
    ...
    Z === e &&
      (q & n) === n &&
      (Y === 4 || (Y === 3 && (q & 130023424) === q && 500 > W() - Co) ? xt(e, 0) : (xo |= n)),
    de(e, t);
}
function Xa(e, t) {
...
Ga = function (e, t, n) {
  ...
  else (ae = !1), F && t.flags & 1048576 && bs(t, Br, t.index);
  switch (((t.lanes = 0), t.tag)) {
      ...
      return (
        ...
        typeof l == 'object' && l !== null && typeof l.render == 'function' && l.$$typeof === void 0
          ? ((t.tag = 1),
            ...
            xu(t, r, e, n),
            (t = Nu(null, t, r, !0, u, n)))
          : ((t.tag = 0), F && u && lo(t), le(null, t, l, n), (t = t.child)),
        t
      );
    case 16:
      r = t.elementType;
    ...
    case 4:
      return (
        po(t, t.stateNode.containerInfo),
        (r = t.pendingProps),
        e === null ? (t.child = en(t, null, r, n)) : le(e, t, r, n),
        t.child
      );
    case 11:
      return (
...
function fl(e, t, n, r) {
  return (
    (e = Se(22, e, r, t)), (e.elementType = os), (e.lanes = n), (e.stateNode = { isHidden: !1 }), e
  );
}
function Hl(e, t, n) {
  ...
  switch (e.tag) {
    case 3:
      ...
      if (t.current.memoizedState.isDehydrated) {
        ...
        n !== 0 && (Zu(t, n | 1), de(t, W()), !(R & 6) && ((rn = W() + 500), mt()));
      }
      break;
    case 13:
      Tt(function () {
  ...
  return (
    wt.useEffect(() => {
      const i = setTimeout(async () => {
        ...
        u(!0);
        try {
          const s = `https://api.mymemory.translated.net/get?q=${encodeURIComponent(e)}&langpair=zh|en`,
            c = await fetch(s, { method: 'GET', headers: { Accept: 'application/json' } });
          if (!c.ok) throw new Error(`HTTP error! status: ${c.status}`);
          const m = await c.json();
          if (m && m.responseData && m.responseData.translatedText)
            r(m.responseData.translatedText);
          else throw new Error(m.responseMessage || '翻译返回数据格式错误');
        } catch (s) {
          console.error('翻译出错：', s),
      ...
      children: [
        Pe.jsxs('div', {
          ...
          children: [
            ...
            Pe.jsx('textarea', {
              className:
                'flex-1 w-full p-4 border rounded-lg resize-none focus:outline-none focus:ring-2 focus:ring-blue-500 dark:bg-gray-700 dark:text-white dark:border-gray-600',
              value: e,
        ...
        Pe.jsxs('div', {
          ...
          children: [
            ...
            Pe.jsx('div', {
              className:
                'flex-1 w-full p-4 border rounded-lg bg-gray-50 dark:bg-gray-700 dark:text-white dark:border-gray-600 overflow-auto',
              children: l
                ? Pe.jsx('div', {
...
Ql.createRoot(document.getElementById('root')).render(
  Pe.jsx(gc.StrictMode, { children: Pe.jsx(Rd, {}) })
);
